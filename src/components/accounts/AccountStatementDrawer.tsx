      ...
      <div className="bg-white w-full max-w-4xl h-full shadow-2xl border-l border-slate-200/80 flex flex-col overflow-hidden animate-slide-left">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 rounded-full text-[10px] font-extrabold uppercase tracking-wider bg-white/15 text-slate-200">
                  {account.account_type.replace('_', ' ')}
                </span>
                {!account.is_active && (
                  <span className="px-2 py-0.5 rounded-full text-[10px] font-extrabold uppercase tracking-wider bg-rose-500/20 text-rose-300">
                    Inactive
                  </span>
                )}
              </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 p-6 bg-slate-50 border-b border-slate-200">
          <div className="bg-white p-3.5 rounded-xl border border-slate-200 shadow-xs">
            <div className="text-[10px] font-black uppercase tracking-wider text-slate-400">Opening Balance</div>
          ...
          <div className="bg-white p-3.5 rounded-xl border border-slate-200 shadow-xs">
            <div className="text-[10px] font-black uppercase tracking-wider text-slate-400">Total Inflow (+)</div>
          ...
          <div className="bg-white p-3.5 rounded-xl border border-slate-200 shadow-xs">
            <div className="text-[10px] font-black uppercase tracking-wider text-slate-400">Total Outflow (-)</div>
          ...
          <div className="bg-white p-3.5 rounded-xl border border-slate-200 shadow-xs">
            <div className="text-[10px] font-black uppercase tracking-wider text-slate-400">Net Period Flow</div>
        ...
        <div className="p-4 bg-white border-b border-slate-200/80 flex flex-wrap items-center justify-between gap-3">
          <div className="flex flex-wrap items-center gap-2.5">
            <div className="flex items-center gap-1.5 bg-slate-50 border border-slate-200 px-2.5 py-1.5 rounded-xl text-xs">
              ...
              <span className="text-slate-400 font-bold text-[10px] uppercase">From:</span>
              <input
                type="date"
                value={dateFrom}
                onChange={(e) => {
                    ...
                    return (
                      <tr key={tx.id} className="hover:bg-slate-50/80 transition-colors">
                        ...
                        <td className="py-3 px-4 whitespace-nowrap">
                          <span
                            className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-extrabold border ${cfg.color}`}
                          >
