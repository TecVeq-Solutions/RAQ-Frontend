    ...
    <div className="space-y-6 animate-fadeIn print:space-y-4 print:p-0">
      ...
      {supplier && (
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm grid grid-cols-1 md:grid-cols-4 gap-6 print:border-none print:shadow-none print:p-0 print:grid-cols-2">
          <div>
            <div className="text-xs font-bold text-slate-400 uppercase tracking-wider">Vendor / Company Name</div>
          ...
          <div>
            <div className="text-xs font-bold text-slate-400 uppercase tracking-wider">Contact Person</div>
          ...
          <div className="md:text-right print:text-left">
            <div className="text-xs font-bold text-slate-400 uppercase tracking-wider">Total Payable</div>
